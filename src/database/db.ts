  ...
  try {
    ...
    await db.unsafe(`
      CREATE TABLE IF NOT EXISTS show_notes (
        ...
        transcription_service TEXT CHECK(transcription_service IN ('groq', 'deepinfra', 'happyscribe', 'fal', 'gladia', 'elevenlabs', 'rev', 'assembly', 'deepgram', 'soniox', 'sixtydb')),
        ...
        tts_service TEXT CHECK(tts_service IN ('openai', 'elevenlabs', 'groq', 'sixtydb')),
        tts_model TEXT,
        tts_voice TEXT,
        tts_audio_file TEXT,
