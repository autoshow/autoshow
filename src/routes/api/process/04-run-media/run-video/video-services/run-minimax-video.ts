...
import type {
GenerateVideoResult,IProgressTracker,
SourceRoutesApiProcess04RunMediaRunVideoVideoServicesRunMinimaxVideoMinimaxFileResponse as MinimaxFileResponse,
SourceRoutesApiProcess04RunMediaRunVideoVideoServicesRunMinimaxVideoMinimaxQueryResponse as MinimaxQueryResponse,
SourceRoutesApiProcess04RunMediaRunVideoVideoServicesRunMinimaxVideoMinimaxResolution as MinimaxResolution,
SourceRoutesApiProcess04RunMediaRunVideoVideoServicesRunMinimaxVideoMinimaxVideoResponse as MinimaxVideoResponse,
VideoModel,
VideoPromptType,
VideoSize
} from '~/types'
...
const createMinimaxVideoJob = async (
  ...
  const safePrompt = model.startsWith('T2V-01')
