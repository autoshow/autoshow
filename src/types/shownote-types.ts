...
export const ShowNoteSchema = v.object({
  ...
  transcription_service: v.nullable(v.union([v.literal('groq'), v.literal('deepinfra'), v.literal('happyscribe'), v.literal('fal'), v.literal('gladia'), v.literal('elevenlabs'), v.literal('rev'), v.literal('assembly'), v.literal('deepgram'), v.literal('soniox'), v.literal('sixtydb')])),
  ...
  tts_service: v.nullable(v.union([v.literal('openai'), v.literal('elevenlabs'), v.literal('groq'), v.literal('sixtydb')])),
