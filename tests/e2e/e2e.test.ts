...
import { createTests as createTests1mLocal } from "./1m-local.test"
import { createTests as createTests5mLocal } from "./5m-local.test"
import { createTests as createTests10minDirect } from "./10min-direct.test"
import { createTests as createTests20minDirect } from "./20min-direct.test"
...
const allTests = [
  ...createTests1mLocal,
  ...createTests5mLocal,
  ...createTests10minDirect,
  ...createTests20minDirect,
...
describe("E2E: Process API", () => {
  ...
  afterAll(async () => {
    ...
    await writeTestReport(report, "tests/e2e/e2e-report.json")
